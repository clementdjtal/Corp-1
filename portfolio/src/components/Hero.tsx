  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl sm:text-2xl text-blue-600 dark:text-blue-400 mb-6">
          {profile.title}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="#projects"
            className="px-8 py-3 border border-gray-300 dark:border-gray-600 rounded-full font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
          >
            {t("hero.viewProjects")}
          </a>
        </div>
